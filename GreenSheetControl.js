...
var flyeringHash = {
	2 : {
		"name" : "entry.152483661",
		"id" : "entry_152483661",
		"title" : "Dates"
	},
	3 : {
		"name" : "entry.410330033",
		"id" : "entry_410330033",
		"title" : "Flyering Events"
	},
	4 : {
		"name" : "entry.338169620",
		"id" : "entry_3381696200",
		"title" : "Chairs"
	}
}
var chalkHash = {
	2 : {
		"name" : "entry.1020853986",
		"id" : "entry_1020853986",
		"title" : "Dates"
	},
	3 : {
		"name" : "entry.431805146",
		"id" : "entry_431805146",
		"title" : "Chalkboarding Events"
	},
	4 : {
		"name" : "entry.1704516184",
		"id" : "entry_1704516184",
		"title" : "Chairs"
	}
}
...
function addRowSmall(tableName) {
	...
	case "makeup_table":
		...
		break;
	case "chalkboarding_table":
		hash = chalkHash;
		row = table.insertRow(++chalkRows);
		break;
	case "flyering_table":
		hash = flyeringHash;
		row = table.insertRow(++flyeringRows);
		break;
	default:
		// shouldn't happen
		hash = icEventHash;
	...
	case "makeup_table":
		...
		break;
	case "flyering_table":
		cell1.innerHTML = flyeringRows;
		break;
	case "chalkboarding_table":
		cell1.innerHTML = chalkRows;
		break;
	default:
		cell1.innerHTML = 0;
	}
...
function addFlyeringRow() {
	addRowSmall("flyering_table");
}

function addChalkboardingRow() {
	addRowSmall("chalkboarding_table");
}
